...
<div class="max-w-sm rounded overflow-hidden shadow-lg bg-white">
  ...
  <h2 class="text-gray-900 title-font text-xl font-medium"><?php echo $row["prg_name"];?></h2>
          ...
          <a href="program_detail1.php?id=<?=$row['prg_id']?>" class="text-white bg-gradient-to-r from-black via-black to-black hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-pink-300 dark:focus:ring-pink-800 font-medium rounded-lg text-sm px-1 py-3 text-center">ดูรายละเอียด</a>
        </div>
      </div>
      <?php
                                }
